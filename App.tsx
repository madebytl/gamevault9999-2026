...
const App = () => {
  ...
  const handleLogin = (user: string) => {
      setUsername(user);
      setMessages([
        { role: 'model', text: `Welcome to GAME VAULT ONLINE, ${user}! I'm the Boss here. Need chips? Just ask!` }
      ]);
      setHasEntered(true);
      ...
      <div className="min-h-screen bg-[#050b14] text-white flex flex-col relative overflow-x-hidden">
        ...
        <nav className="p-4 flex justify-between items-center bg-slate-900/50 backdrop-blur border-b border-white/10 z-20">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-vault-purple arcade-font">
              GAME VAULT
            </h1>
          </div>
